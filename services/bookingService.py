...
class BookingService:
    @staticmethod
    def book_tickets(db: Session, event_id: int, tickets: int, success_url: str, cancel_url: str) -> BookingResponse:
        ...
        stripe_adapter = StripeAdapter(api_key="sk_test_51N04I3SFZ5NhuMix5R4gKyOGARimRCXCihXhZzoruDgWhuafxiE059kH4hGhvF6gLcdSniyk4Fi791AwEB9WymQI00ZWOCXEt5")
